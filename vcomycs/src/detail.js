function execute(url) {
    ...
    var tags = doc.select(".comic-info .tags")
    ...
    return Response.success({
        ...
        detail : "Other name: "+ doc.select(".comic-intro-text span")[0].text() + "<br>"
        + "Author: " + doc.select(".comic-intro-text span")[1].text() + "<br>"
        + "Illustrator: " + doc.select(".comic-intro-text span")[2].text() + "<br>"
        + "Status: "+ ongoing + "<br>"
